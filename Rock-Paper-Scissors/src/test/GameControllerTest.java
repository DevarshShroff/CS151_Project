...
public class GameControllerTest {
    ...
    static class StubRules implements IRules {
        ...
        public StubRules(int fixedResult) { this.fixedResult = fixedResult; }
        @Override public int decideWinner(Move m1, Move m2) { return fixedResult; }
    }
    

    public static void main(String[] args) {
        testGameController_LoopsCorrectly();
        // Silently exits if all tests pass
    }

    private static void testGameController_LoopsCorrectly() {
